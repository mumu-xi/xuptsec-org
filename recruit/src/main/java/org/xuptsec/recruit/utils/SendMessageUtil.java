...
import org.xuptsec.recruit.poji.MessageStatus;
...
public class SendMessageUtil {
    ...
    public static SendSmsResponse sendSms(String tel, String verification) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("信安实验室");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_96535041");
    ...
    public static MessageStatus sendMessage(String tel, String verification) throws ClientException, InterruptedException {
        //发短信
        SendSmsResponse response = sendSms(tel, verification);
        ...
        if (response.getCode() != null && response.getCode().equals("OK")) {
            QuerySendDetailsResponse querySendDetailsResponse = querySendDetails(response.getBizId(), tel);
